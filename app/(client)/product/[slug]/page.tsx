  ...
  return (
      <Container className='py-10 flex flex-col md:flex-row gap-10'>
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          {product?.stock && <p className='bg-green-100 w-24 text-center text-green-600 text-sm py-2.5 font-semibold rounded-lg'>
            In Stock
            </p>}
            ...
            <div className=' flex flex-wrap items-center gap-5'>
              ...
              <div className='border border-darkBlue/20 text-center p-3 hover:border-darkBlue rounded-md hoverEffect'>
                <p className='text-base font-semibold text-darkColor'>Flexible</p>
                <p className='text-sm text-gray-500'>Pay with Multiple Credit Card</p>
              </div>
            </div>
        </div>
      </Container>
